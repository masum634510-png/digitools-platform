    ...
    <>
      ...
      <div className='text-center my-10'>
        ...
        <div className='flex flex-row  gap-4 w-2/12 mx-auto p-2 bg-white shadow mt-2 rounded-3xl'>
          <button className='btn text-white bg-[linear-gradient(87.40deg,rgba(79,57,246,1),rgba(149,20,250,1))] rounded-3xl'>
            Products
          </button>
          <button className='cursor-pointer'>Cart({cart.length})</button>
        </div>
      </div>
